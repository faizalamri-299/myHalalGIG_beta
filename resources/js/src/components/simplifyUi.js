...
export const EditableLabel = ({value,label,icon,onChange,onSave,...props})=> {
...
return  editMode ?
      ...
      <Icon onClick={()=>{setEditMode(true);setNewValue(value)}} size="small" name='pencil' color="green" link /></Header>
