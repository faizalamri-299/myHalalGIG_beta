...
import {UploadHASContext,
        postHASTraining,
        deleteHASTraining} from './UploadHAS';
  ...
  const RenderHAS = props => {
    ...
    <Table.Row >
     ...
     <Button.Group basic floated='right' size='small'>
      <Popup content='Muat Turun Fail'position='top center' trigger={<Button href={"/files/HASFILE/"+x.cmpnyFK+"/"+x.training_filename} target="_blank"  icon='download' />} />
