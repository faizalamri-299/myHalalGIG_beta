...
const SubscriptionList = () => {
  ...
  const RenderSubscription = props => {
    ...
    <Table.Cell>{x.subcrDetails.address}</Table.Cell>
    <Table.Cell>{x.subcrDetails.phone}</Table.Cell>
    <Table.Cell>{x.subcrDetails.email}</Table.Cell>
    {/* <Table.Cell>
  ...
  return <Table>
    <Table.Header>
      <Table.Row>
        ...
        <Table.HeaderCell>No Pendaftaran Syarikat</Table.HeaderCell>
        <Table.HeaderCell>Jenis Pendaftaran</Table.HeaderCell>
        <Table.HeaderCell>Alamat</Table.HeaderCell>
        <Table.HeaderCell>No Telefon</Table.HeaderCell>
        <Table.HeaderCell>Emel Syarikat</Table.HeaderCell>
