...
const TabOrgIHC = () => {
  ...
  <Header as='h3'>Rekod Carta Organisasi Internal Halal Control (IHC)</Header>
      <Table celled>
        <Table.Header>
          <Table.Row>
        ...
        <Table.Body>
          <Table.Row>
            ...
            <Table.Cell><Button color="teal" 
                                fluid 
                                href="/files/CARTA ORGANISASI INTERNAL HALAL COMMITTEE.docx"
