...
if (cmpny)
  ...
  return (
    ...
    <Table.Header>
      <Table.Row>
        ...
        <Table.HeaderCell>Senarai Carta Organisasi</Table.HeaderCell>
    ...
    <Table.Body>
      <Table.Row>
        ...
        <Table.Cell>Carta Organisasi (Versi Bahasa Inggeris)</Table.Cell>
        <Table.Cell><Button color="teal" 
                                fluid 
                                href="/files/INTERNAL HALAL COMMITTEE.docx"
  ...
  <Header as='h3'>Surat Pelantikan</Header>
    ...
    <Table.Header>
      <Table.Row>
        <Table.HeaderCell>No</Table.HeaderCell>
        <Table.HeaderCell>Senarai Surat Pelantikan</Table.HeaderCell>
        <Table.HeaderCell>Templat</Table.HeaderCell>
      </Table.Row>
    </Table.Header>
    ...
    <Table.Body>
      <Table.Row>
        <Table.Cell>1</Table.Cell>
        <Table.Cell>Surat Pelantikan (Versi Bahasa Melayu)</Table.Cell>
        <Table.Cell><Button color="teal" 
                                fluid 
      ...
      <Table.Row>
        <Table.Cell>2</Table.Cell>
        <Table.Cell>Surat Pelantikan (Versi Bahasa Inggeris)</Table.Cell>
        <Table.Cell><Button color="teal" 
                                fluid 
                                href="/files/LETTER OF EMPLOYMENT.docx"
                                target="_blank">Muat Turun
                        </Button>
        </Table.Cell>
      </Table.Row>
