  ...
  <Segment.Group >
          <Segment>
            ...
            {cmpnydata.cmpnyConfig && <React.Fragment>
                ...
                <Menu.Item header  as="h3" style={{color:cmpnydata.cmpnyConfig.headerTextColor? cmpnydata.cmpnyConfig.headerTextColor:""}}>{cmpnydata.cmpnyConfig.appName? cmpnydata.cmpnyConfig.appName:cmpnydata.cmpnyName+" My Halal Gig"}</Menu.Item>
                </Menu>
                </React.Fragment>}
                </Segment>
              </Segment.Group> 
